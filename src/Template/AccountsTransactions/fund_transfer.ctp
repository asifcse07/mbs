...
<div class="accountsTransactions form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('account_id', ['options' => $accounts, 'empty' => 'Select Account No', 'label' => 'Transfer From']);
            echo $this->Form->control('fund_transfer_acc_no', ['placeholder' => 'Account No', 'label' => 'Transfer To']);
