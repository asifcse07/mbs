...
Router::scope('/', function (RouteBuilder $routes) {
     ...
     */
    $routes->connect('/', ['controller' => 'Users', 'action' => 'loginPreview', 'loginPreview']);
    $routes->connect('registerview', ['controller' => 'Users', 'action' => 'registration']);
    $routes->connect('register', ['controller' => 'Users', 'action' => 'saveRegister']);
